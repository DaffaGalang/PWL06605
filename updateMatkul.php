...
<body>
	...
	<!--cari    <form action="" method="post" class="form-inline">
					...
					?>
						<tr>
							...
							<td>
								...
								<a class="btn btn-outline-danger btn-sm" href="hpsMatkul.php?kode=<?php echo enkripsiurl($row['idmatkul']) ?>" id="linkHps" onclick="return confirm('Yakin dihapus ?')">Hapus</a>
							</td>
						</tr>
				<?php
						$no++;
